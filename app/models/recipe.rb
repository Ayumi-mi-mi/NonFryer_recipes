class Recipe < ApplicationRecord
  ...
  validates :preheat_time, numericality: { only_integer: true, greater_than_or_equal_to: 0 }, allow_nil: true
  validates :preheat_temperature, numericality: { only_integer: true, greater_than_or_equal_to: 0 }, allow_nil: true
