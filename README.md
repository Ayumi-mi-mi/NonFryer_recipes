...
また、SNSやブラウザのURLを登録するだけでAIがレシピを抽出してくれるサービスは既に存在しているが、キャプションに説明がないと文章が反映されなかったりと使いづらい点もある。そのため、レシピをURLの埋め込みで表示することによって、レシピによって表示されないというリスクを無くす。
